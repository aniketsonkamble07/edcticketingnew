"""
Django settings for EDCproject project.
...
SECRET_KEY = 'kmz0)$h#_)+@8d@fl)yyq^ok+7*1_-czed7$6i9roctl2*51y8'
...
WSGI_APPLICATION = 'EDCproject.wsgi.application'
